                        ...
                        @foreach($purchase_orders as $r)
                          <tr>
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                    <div class="flex items-center gap-x-2">
                                        <div>
                                            <h2 class="text-sm font-medium text-gray-800 dark:text-white ">{{ucfirst($r->type)}}</h2>
                                ...
                                <div>
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{{$r->category->name }} ({{($r->category->code)}})</td>
