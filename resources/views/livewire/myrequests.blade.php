                        ...
                        @foreach($purchase_orders as $r)
                          ...
                          <tr>
                                ...
                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap ">
                                    <div class="inline-flex items-center px-3 py-1 text-gray-500 rounded-full gap-x-2 dark:bg-gray-800 {{$r->status=='paid'?'bg-green-400':''}} {{$r->status=='pending'?'bg-yellow-400':''}} {{$r->status=='declined'?'bg-red-400':''}} {{$r->status=='approved'?'bg-blue-400':''}}">
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                    <div class="flex items-center gap-x-2">
                                        <div>
                                            <h2 class="text-sm font-medium text-gray-800 dark:text-white ">{{$r->toUser->name}}</h2>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
